...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container-fluid px-0 h-100"  style="background-image: url('/top3.jpg'); background-size: cover; background-position: center;">
                ...
                <div class="row gx-0 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Welcome to Household Services, 
                            ...
                            Explore our range of services today and experience the convenience of having a home that's taken care of by the best in the business.</p>
        ...
        <section class="page-section" id="login">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                            <!-- Submit Button-->
                            <div class="d-grid"><a class="btn btn-primary btn-xl" href="{{ route('booking.index') }}">Book now</a>
                    </div>
                </div>
            </div>
        </section>
